  ...
  const courses = [
    {
      ...
      description: 'Master STAAD.Pro, ETABS, AutoCAD, and Revit for professional structural engineering projects.',
      instructor: 'Er. Vishal More',
    ...
    },
    {
      ...
      description: 'Learn advanced techniques for designing structures that can withstand seismic activity.',
      instructor: 'Er. Vishal More',
    ...
    {
      id: '003',
      title: 'Structural Project Management',
      description: 'Master the art of managing structural engineering projects from conception to completion.',
      instructor: 'Er. Vishal More',
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Specialized engineering courses taught by industry experts.
              </p>
            </div>
            <Link
              to="/courses"
